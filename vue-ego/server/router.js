...
// 调取产品数据
router.get("/backend/item/selectTbItemAllByPage",bodyParser.json(),(req,res)=>{
    // 接口参数：page
    var page = url.parse(req.url,true).query.page || 1;  //oeder by id 排序
    const sql = "select * from project order by id desc limit 10 offset "+(page - 1) * 10;//offset 偏移量
...
// 返回数据总条数
router.get("/total",bodyParser.json(),(req,res)=>{
